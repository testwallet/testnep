Contributing to Nepton Core
============================

The Nepton Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nepton Core project, and is not to be
confused with overall Nepton Network Protocol consensus changes.

Whether a pull request is merged into Nepton Core rests with the project merge
...
Patches that change Nepton consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nepton consensus, it must have been
...
The project leader is the release manager for each Nepton Core release.
