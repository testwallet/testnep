...
RESOURCES += src/qt/Nepton.qrc src/qt/Nepton_locale.qrc

TRANSLATIONS += src/qt/locale/Nepton_bg.ts \
                src/qt/locale/Nepton_de.ts \
                src/qt/locale/Nepton_en.ts \
                src/qt/locale/Nepton_es.ts \
                src/qt/locale/Nepton_fi.ts \
                src/qt/locale/Nepton_fr.ts \
                src/qt/locale/Nepton_it.ts \
                src/qt/locale/Nepton_ja.ts \
                src/qt/locale/Nepton_pl.ts \
                src/qt/locale/Nepton_pt.ts \
                src/qt/locale/Nepton_ru.ts \
                src/qt/locale/Nepton_sk.ts \
                src/qt/locale/Nepton_sv.ts \
                src/qt/locale/Nepton_vi.ts \
                src/qt/locale/Nepton_zh_CN.ts \
                src/qt/locale/Nepton_zh_TW.ts
