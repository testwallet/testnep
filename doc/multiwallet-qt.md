...
In order to support loading of multiple wallets in Nepton-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Nepton.cpp.
...
Changes to Nepton.cpp
----------------------
Nepton.cpp is the entry point into Nepton-qt, and as such, will require some minor modifications to provide hooks for
