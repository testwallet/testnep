...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nepton Core Nepton-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Nepton-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Nepton transaction") + "\n" +
                               "  Nepton-tx [options] -create [commands]   " + _("Create hex-encoded Nepton transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Nepton transaction
