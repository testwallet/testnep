/* src/config/Nepton-config.h.  Generated from Nepton-config.h.in by configure.  */
/* src/config/Nepton-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define this symbol if you have MSG_NEPIGNAL */
/* #undef HAVE_MSG_NEPIGNAL */
...
#define PACKAGE_BUGREPORT "www.Nepton.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nepton Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nepton Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Nepton"
