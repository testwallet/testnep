...
bool static Socks5(string strDest, int port, const ProxyCredentials *auth, SOCKET& hSocket)
{
    ...
    ssize_t ret = send(hSocket, (const char*)begin_ptr(vSocks5Init), vSocks5Init.size(), MSG_NEPIGNAL);
    ...
    if (pchRet1[1] == 0x02 && auth) {
        ...
        ret = send(hSocket, (const char*)begin_ptr(vAuth), vAuth.size(), MSG_NEPIGNAL);
    ...
    ret = send(hSocket, (const char*)begin_ptr(vSocks5), vSocks5.size(), MSG_NEPIGNAL);
...
bool static ConnectSocketDirectly(const CService& addrConnect, SOCKET& hSocketRet, int nTimeout)
{
    ...
    setsockopt(hSocket, SOL_SOCKET, SO_NEPIGPIPE, (void*)&set, sizeof(int));
#endif
