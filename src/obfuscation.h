...
{
public:
    /// Is the inputs associated with this public key? (and there is 25000 NEP - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of Nepton.
