                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nepton Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nepton address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Nepton: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNEP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nepton Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nepton Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nepton"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nepton addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nepton addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagNeptontic information"));
    ...
    openAction->setStatusTip(tr("Open a Nepton: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nepton Core help message to get a list with possible Nepton command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nepton Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nepton network", "", count));
}
...
{
    QString strTitle = tr("Nepton Core"); // default title
...
/** Creates context menu, its actions, and Neptons up all the relevant signals for mouse events. */
