...
/** Utility functions used by the Nepton Qt UI.
 */
namespace GUIUtil
{
...
// Render Nepton addresses in moNeptonpace font
...
// Parse "Nepton:" URI into recipient object, return true on successful parsing
