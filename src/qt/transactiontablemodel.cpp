...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Nepton to zNepton");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zNepton");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Nepton from zNepton");
    case TransactionRecord::ZerocoinSpend_Change_zNepton:
        return tr("Minted Change as zNepton from zNepton Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zNepton to Nepton");
