...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nepton features */
        {"Nepton", "masternode", &masternode, true, true, false},
        {"Nepton", "listmasternodes", &listmasternodes, true, true, false},
        {"Nepton", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Nepton", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Nepton", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Nepton", "masternodedebug", &masternodedebug, true, true, false},
        {"Nepton", "startmasternode", &startmasternode, true, true, false},
        {"Nepton", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Nepton", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Nepton", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Nepton", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Nepton", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Nepton", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Nepton", "mnbudget", &mnbudget, true, true, false},
        {"Nepton", "preparebudget", &preparebudget, true, true, false},
        {"Nepton", "submitbudget", &submitbudget, true, true, false},
        {"Nepton", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Nepton", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Nepton", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Nepton", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Nepton", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Nepton", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Nepton", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Nepton", "checkbudgets", &checkbudgets, true, true, false},
        {"Nepton", "mnsync", &mnsync, true, true, false},
        {"Nepton", "spork", &spork, true, true, false},
        {"Nepton", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Nepton", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Neptond, or the -server option to Nepton-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Nepton-cli " + methodname + " " + args + "\n";
}
