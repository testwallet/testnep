...
// Nepton: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_2_NEPTONFAST) r = SPORK_2_NEPTONFAST_DEFAULT;
        if (nSporkID == SPORK_3_NEPTONFAST_BLOCK_FILTERING) r = SPORK_3_NEPTONFAST_BLOCK_FILTERING_DEFAULT;
...
{
    if (strName == "SPORK_2_NEPTONFAST") return SPORK_2_NEPTONFAST;
    if (strName == "SPORK_3_NEPTONFAST_BLOCK_FILTERING") return SPORK_3_NEPTONFAST_BLOCK_FILTERING;
...
{
    if (id == SPORK_2_NEPTONFAST) return "SPORK_2_NEPTONFAST";
    if (id == SPORK_3_NEPTONFAST_BLOCK_FILTERING) return "SPORK_3_NEPTONFAST_BLOCK_FILTERING";
