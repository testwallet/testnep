...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 25000 NEP at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zNEP send
enum ZerocoinSpendStatus {
    ZNEP_SPEND_OKAY = 0,                            // No error
    ZNEP_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZNEP_WALLET_LOCKED = 2,                         // Wallet was locked
    ZNEP_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZNEP_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZNEP_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZNEP_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZNEP_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZNEP_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZNEP_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZNEP_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZNEP_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZNEP_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZNEP_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZNEP_SPENT_USED_ZNEP = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZNeptonAutoBackups(bool fEnabled)
    {
